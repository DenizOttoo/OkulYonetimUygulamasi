...
namespace OkulYonetimUygulmasi
{
    internal class Program
    {
            ...
            while (true)
            {
                ...
                switch (secim)
                {
                    ...
                    case "2":
                        ...
                        break;
                    case "3":
                        CinsiyeteGoreOgrenciler("Kirada");
                        break;
                    case "4":
                        TarihSonrasıDoganlar("Galeride");
                        break;
                    case "5":
                        IllereGoreOgrenciler("ArabaYok");
                        break;
                    case "6":
                        OgrencininNotları();
                        break;
        ...
        {
            Okul.OgrenciEkle(1, "ali", "soyad", new DateTime(2000, 5, 4), CINSIYET.Erkek, SUBE.A);
